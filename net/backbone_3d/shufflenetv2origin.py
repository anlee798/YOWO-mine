...
class ShuffleNetV2(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.features(out) #out.size() torch.Size([1, 464, 1, 7, 7])
        if out.size(2) > 1:
        ...
        # print("self.conv_last(out).size()",out.size())
...
if __name__ == "__main__":
   ...
   # model = model.cuda()
    ...
    print(output.shape)
    #flops,params,results = count_flops_params(model,input_var)
    
'''
python shufflenetv2origin.py
'''
